    ...
    <div className='memberBack termsBack'>
      <div className='memberBox'>
        ...
        <div className='memberColumn termsColumn'>
          ...
          <div>
            <textarea name="" id="" readOnly value={terms}>웹사이트 서비스 이용 약관 (필수)</textarea>
          </div>
        ...
        <div className='memberColumn termsColumn'>
          ...
          <div>
            <textarea name="" id="" readOnly value={privacy}>개인 정보 동의 이용 약관 (필수)</textarea>
          </div>

          <label htmlFor="agree2">동의
