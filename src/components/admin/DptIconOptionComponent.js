import { faBarsProgress, faBolt, faBriefcase, faCircleInfo, faCode, faComments, faEnvelope, faGears, faGlobe, faHeadset, faLightbulb, faMicrochip, faNetworkWired, faUser, faUserGear, faUsers, faUsersViewfinder } from '@fortawesome/free-solid-svg-icons'
